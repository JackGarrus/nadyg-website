...
Smart play. After all, containerd runs Docker images. And where are most of those stored? On Docker Hub (hehe).
...
<br />
But then <strong>Docker Inc. started charging for Docker Desktop</strong> in certain cases, and developers looked for alternatives.
