      ...
      <div className={s.page}>
        <div className={s.container}>
          <section className={s.yapSection}>
            ...
            >
              Hi, I am <strong>Nadia G.</strong> from Berlin, a seasoned
              software engineer with 9 years of experience @ Doctolib.
            </motion.p>
            <br />
            <br />
            <motion.p
            ...
            >
              ...
              with new ideas and building tools that solve problems, whether
              it’s something simple to make my life a little easier or a more
              complex project that challenges my skills.
            </motion.p>
            <br />
            <br />
            <motion.p
            ...
            >
              ...
              <strong>coding tips</strong>, <strong>productivity hacks</strong>{" "}
              to reflections on my <strong>job journey</strong> and the{" "}
            ...
            >
              When I’m away from the screen, you’ll find me hiking through
              nature, exploring the outdoors, and tending to my plants.
            </motion.p>
            <br />
            <br />
            <br />
      ...
      <div className={s.page}>
        <div className={s.container}>
          <section className={s.contactsSection}>
            ...
            <br />
            <p className="paragraph">Send me an email at:</p>
            <div>
              <button onClick={() => copy("nadguar@proton.me")}>
                nadguar@proton.me
              </button>
            ...
            <br />
            <p className="paragraph">Find me on Linkedin</p>
            <br /> <br />
            <p className="paragraph">
              Find out my other work: unsplash, soundcloud{" "}
            </p>
          </section>
        </div>
      </div>
